...
Log levels, transports, child loggers, and Err integration.

Generated from [`src/utils/logger.examples.test.ts`](https://github.com/pencroff-lab/kore/blob/v0.7.0/src/utils/logger.examples.test.ts).
