...
Compact, sortable date and time stamps.

Generated from [`src/utils/format_dt.examples.test.ts`](https://github.com/pencroff-lab/kore/blob/v0.7.0/src/utils/format_dt.examples.test.ts).
