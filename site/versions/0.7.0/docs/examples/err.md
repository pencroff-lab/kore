...
Error creation, wrapping, codes, metadata, and serialization.

Generated from [`src/types/err.examples.test.ts`](https://github.com/pencroff-lab/kore/blob/v0.7.0/src/types/err.examples.test.ts).
